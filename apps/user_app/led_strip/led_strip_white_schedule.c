...
void led_strip_white_schedule_init(void)
{
    ...
    led_strip_white.period_cnt =
        led_strip_white.period * 1000; // 周期值计数值，单位 ms
...
void led_strip_white_schedule(void)
{
    ...
    if (led_strip_white.is_dev_open == DEVICE_OFF) {
        ...
        WS2812FX_setSegment_colorOptions(LED_STRIP_WHITE_SEG_INDEX,  // 第 x 段
        ...
        WS2812FX_resetSegmentRuntime(
            LED_STRIP_WHITE_SEG_INDEX); // 重置流星灯所在的段运行时参数
    ...
    if (led_strip_white.mode_index == 1) {
        ...
        meteor_light_mode_ptr =
            &led_strip_white_anim_comet_1_whit_max_brightness;
        opt = FADE_FAST; // 选项
        ...
        meteor_light_mode_ptr =
            &led_strip_white_anim_comet_1_whit_max_brightness;
        opt = FADE_SLOW;                          // 选项
    } else if (led_strip_white.mode_index == 3) { // 单流星（反向）
        meteor_light_mode_ptr =
            &led_strip_white_anim_comet_1_whit_max_brightness;
        ...
        meteor_light_mode_ptr =
            &led_strip_white_anim_comet_4_with_max_brightness;
        opt = NO_OPTIONS; // 选项
        ...
        meteor_light_mode_ptr =
            &led_strip_white_anim_half_flow_with_max_brightness;
        opt = FADE_MEDIUM; // 选项
        ...
        // 单点流水，最后四个灯堆积
        meteor_light_mode_ptr =
            &led_strip_white_anim_single_flow_and_stack_with_max_brightness;
        opt = NO_OPTIONS; // 选项
        ...
        // 堆积流水
        meteor_light_mode_ptr =
            &led_strip_white_anim_stack_flow_with_max_brightness;
        opt = NO_OPTIONS; // 选项
        ...
        // 堆积流水(正向) + 堆积流水(反向)
        meteor_light_mode_ptr =
            &led_strip_white_anim_stack_flow_plus_reverse_with_max_brightness;
        opt = NO_OPTIONS; // 选项
    } else if (led_strip_white.mode_index == 15) {
        // 音乐律动1
        meteor_light_mode_ptr =
            &led_strip_white_anim_sound_control_meteor_with_max_brightness;
        opt = NO_OPTIONS; // 选项
    } else if (led_strip_white.mode_index == 16) {
        // 音乐律动2
        meteor_light_mode_ptr =
            &led_strip_white_anim_sound_control_meteor3_with_max_brightness;
        opt = NO_OPTIONS; // 选项
    } else {
        // index 不在 索引范围内，直接返回
        return;
